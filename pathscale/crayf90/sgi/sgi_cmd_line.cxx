...
static const char *rcs_id = "$Source: crayf90/sgi/SCCS/s.sgi_cmd_line.cxx $ $Revision: 1.22 $";
...
//   Configure_Target() ;
   ...
   if (DEBUG_Subscript_Check) {
     add_cray_args("-Rb");
#ifdef KEY /* Bug 14548, 10378 */
     /* Check substrings and pointers too */
     add_cray_args("-Rs");
     add_cray_args("-Rp");
#endif /* KEY Bug 14548, 10378 */
   }
